        ...
        <WidgetContent>
            <WidgetImage>
                <div className="d-flex">
                    <Thumbnail>
                        <div style={{backgroundImage: "url(https://cf.shopee.vn/file/a480cda31decdcf26ea8b92af927328e)"}}>
                            <button>Sửa</button>
                        </div>
            ...
            <WidgetStatistics>
                ...
                <StatisticsRow className="d-flex align-items-center">
                    ...
                    <a href="#/" className="d-flex align-items-center">0<span aria-hidden="true" className="arrow_carrot-right"></span></a>
                </StatisticsRow>
                ...
                <StatisticsRow className="d-flex align-items-center">
                    ...
                    <a href="#/" className="d-flex align-items-center">0,00%<span aria-hidden="true" className="arrow_carrot-right"></span></a>
                </StatisticsRow>
