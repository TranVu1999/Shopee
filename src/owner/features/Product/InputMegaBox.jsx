...
function InputMegaBox({
    ...
    return (
        <WidgetContent>
            <WidgetResultSelected className="d-flex align-items-center justify-content-between">
                <span className="result">Vui lòng chọn</span>
                {/* <label>Vui lòng chọn</label> */}
                <div>
                    {limit !== 0 && (<span className="number">{`${selectedQuantity}/${limit}`}</span>)}
