    ...
    return (
        <Thumbnail to="/product-detail">
            ...
            <div className="box-text">
                ...
                <BoxPrice className="d-flex align-items-center justify-content-between">
                    <div>
